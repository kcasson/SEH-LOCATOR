...
Public Class cItemBinLocations
    '************************************************************************************************
    '*  NAME: cItemBinLocation
    '*	DESC: This class is stores inventory item and bin locations
    '*	AUTHOR: kcasson 
    '*	DATE: 4/9/2009
    '*		
    '*		Modifications:
    ...
    Public Sub New()
        ...
        Dim ds As DataSet = cData.GetBinQuantities("", "", "")
        'Log time finish
    ...
    Public Sub New(ByVal mfrNumber As String, ByVal pmmNumber As String, ByVal desc As String, ByVal user As cUserInfo)
        Dim logNumber As Integer
    ...
    Private Function Load(ByVal ds As DataSet) As Boolean
        ...
        Catch ex As Exception
            LogEvent("Exception Thrown by the following; Function: Load Class: cItemBinLocations " & _
